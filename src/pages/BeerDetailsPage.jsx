  ...
  const getSingleBeer = async () => {
    try {
      const response = await axios.get(
        `https://ih-beers-api2.herokuapp.com/beers/${beerId}` // puede ser tambien: get("https://ih-beers-api2.herokuapp.com/beers/" + beerId );
      );
    ...
    getSingleBeer(); // here u invoke the function / make the request to get the beer
  }, [beerId]);
  ...
  return (
    <div className="d-inline-flex flex-column justify-content-center align-items-center w-100 p-4">
      {beer && (
        <>
          <img
          // Busca una cool! :-) lo cambias en src
            src={beer.image_url} 
            alt="Beer Image"
            height="300px"
            width="auto"
