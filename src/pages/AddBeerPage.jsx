...
function AddBeerPage(props) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();                                   // only when func is in form we need to prev default behavior bc behavior comes from form 
    try {
      const response = await axios.post(
        "https://ih-beers-api2.herokuapp.com/beers/new", { // Body of the request
          name,                                            // object of new beer
          tagline, 
          description,
          imageUrl,
          firstBrewed,
